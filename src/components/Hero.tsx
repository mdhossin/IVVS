...
const HeroInnerBanner: React.FC<{ show: boolean; onClose: () => void }> = ({
  ...
  return (
    <Transition
      ...
      leaveTo="opacity-0"
    >
      <div className="relative rounded bg-gradient-to-r from-white to-gray-10 py-3 px-8 text-center text-black shadow-lg md:rounded-full">
        <p>
          Welcome to <span className="font-bold">Ivves</span>.Industrial-grade Verification and Validation of Evolving Systems
        </p>
  ...
  return (
    <div className="bg-green-700 p-4">  
      <span className="block text-center text-lg text-white">
        ...
        <span className="bg-gradient-to-r from-white-400 to-white-600 bg-clip-text align-middle text-2xl font-black tracking-widest ">
          Ivves
        </span>{" "}
        today.
      </span>
